...
var home = str.link("second page.html");
    ...
    {var x = localStorage.getItem("cat1");
     localStorage.setItem("cat1" , x+"<li>"+name +"</li>");
        ...
        s="It would be best for you to consult a doctor and take prescribed medicine. Make sure to complete the dose of prescribed medicine and it would be best for you to take rest at home rather than trying to get medical aid over at hospital with their symptoms." ;
    ...
    s="Thank you for giving us your precious time. Our organization, we take a look on your symptoms. Make sure to call the doctor and say your symptoms to them. And we will also try to help you out."	
